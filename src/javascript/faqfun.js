$(document).ready(function(){
    $(".faqbox1").click(function(){
        $(".faqbox2").css("transition", "scale 0.8s ease, opacity 0.2s ease");
        $(".faqbox2").css("opacity", "0");
        $(".faqbox2").css("scale", "0.5");
        $(".faqbox2").css("pointer-events", "none");

        $(".faqbox3").css("transition", "scale 0.8s ease, opacity 0.2s ease");
        $(".faqbox3").css("opacity", "0");
        $(".faqbox3").css("scale", "0.5");
        $(".faqbox3").css("pointer-events", "none");

        $(".faqbox4").css("transition", "scale 0.8s ease, opacity 0.2s ease");
        $(".faqbox4").css("opacity", "0");
        $(".faqbox4").css("scale", "0.5");
        $(".faqbox4").css("pointer-events", "none");

        $(".faqbox5").css("transition", "scale 0.8s ease, opacity 0.2s ease");
        $(".faqbox5").css("opacity", "0");
        $(".faqbox5").css("scale", "0.5");
        $(".faqbox5").css("pointer-events", "none");

        $(".faqbox6").css("transition", "scale 0.8s ease, opacity 0.2s ease");
        $(".faqbox6").css("opacity", "0");
        $(".faqbox6").css("scale", "0.5");
        ...
        $(".faqdesc1").css("transition", "opacity 0.3s ease 1.3s");
        $(".faqdesc1").css("opacity", "1");


        $(".faqexit").css("transition", "opacity 0.7s ease-in-out, box-shadow 0.3s ease, background 0.3s ease");
        $(".faqexit").css("opacity", "1");
    });
    $(".faqbox2").click(function(){
        $(".faqbox1").css("transition", "scale 0.8s ease, opacity 0.2s ease");
        $(".faqbox1").css("opacity", "0");
        $(".faqbox1").css("scale", "0.5");
        $(".faqbox1").css("pointer-events", "none");
        ...
        $(".faqdesc2").css("transition", "opacity 0.3s ease 1.3s");
        $(".faqdesc2").css("opacity", "1");
    ...
    $(".faqbox3").click(function(){
        ...
        $(".faqdesc3").css("transition", "opacity 0.3s ease 1.3s");
        $(".faqdesc3").css("opacity", "1");
    ...
    $(".faqbox4").click(function(){
        ...
        $(".faqdesc4").css("transition", "opacity 0.3s ease 1.3s");
        $(".faqdesc4").css("opacity", "1");
    ...
    $(".faqbox5").click(function(){
        ...
        $(".faqdesc5").css("transition", "opacity 0.3s ease 1.3s");
        $(".faqdesc5").css("opacity", "1");

        $(".faqexit").css("transition", "opacity 0.7s ease-in-out, box-shadow 0.3s ease, background 0.3s ease");
        $(".faqexit").css("opacity", "1");
    });
    $(".faqbox6").click(function(){
        $(".faqbox1").css("transition", "scale 0.8s ease, opacity 0.2s ease");
        $(".faqbox1").css("opacity", "0");
        $(".faqbox1").css("scale", "0.5");
        $(".faqbox1").css("pointer-events", "none");
        ...
        $(".faqdesc6").css("transition", "opacity 0.3s ease 1.3s");
        $(".faqdesc6").css("opacity", "1");
    ...
    $(".faqexit").click(function(){
        ...
        $(".faqtitle6").css("opacity", "0.5");
        $(".faqdesc6").css("transition", "opacity 0.15s ease");
        $(".faqdesc6").css("opacity", "0");

        $(".faqexit").css("transition", "opacity 0.7s ease-in-out");
        $(".faqexit").css("opacity", "0");
    });
